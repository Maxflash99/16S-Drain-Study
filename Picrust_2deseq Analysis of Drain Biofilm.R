...
# Display structure of metadata after adjustments
str(metadata)
...
alpha = 0.05
# Define the contrast with levels of Week
my_contrast <- c("Week", "S1","S5")  

# Run DESeq2 with the specified contrast
res <- results(diagdds, contrast = my_contrast, cooksCutoff = FALSE)

# Filter the significant results based on adjusted p-value
...
run_deseq2("Week", "W14", "W6")
run_deseq2("Week", "W14", "W8")
run_deseq2("Week", "W14", "W10")
run_deseq2("Week", "W14", "W12")
run_deseq2("Week", "W14", "W17")
